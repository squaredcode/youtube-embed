...
function ye_video_shortcode( $paras = '', $content = '', $callback = '', $alt_shortcode = false ) {
	...
	$array = array(
		'id'          => sanitize_text_field( $content ),
		'width'       => sanitize_text_field( $width ),
		'height'      => sanitize_text_field( $height ),
		'fullscreen'  => ye_convert( sanitize_text_field( $fullscreen ) ),
		'related'     => ye_convert( sanitize_text_field( $related ) ),
		'autoplay'    => ye_convert( sanitize_text_field( $autoplay ) ),
		'loop'        => ye_convert( sanitize_text_field( $loop ) ),
		'start'       => sanitize_text_field( $start ),
		'info'        => ye_convert( sanitize_text_field( $info ) ),
		'annotation'  => ye_convert_3( sanitize_text_field( $annotation ) ),
		'cc'          => ye_convert( sanitize_text_field( $cc ) ),
		'style'       => sanitize_text_field( $style ),
		'stop'        => sanitize_text_field( $stop ),
		'disablekb'   => ye_convert( sanitize_text_field( $disablekb ) ),
		'ratio'       => sanitize_text_field( $ratio ),
		'controls'    => sanitize_text_field( $controls ),
		'profile'     => sanitize_text_field( $profile ),
		'list_style'  => sanitize_text_field( $list ),
		'template'    => sanitize_text_field( $template ),
		'color'       => sanitize_text_field( $color ),
		'responsive'  => ye_convert( sanitize_text_field( $responsive ) ),
		'search'      => ye_convert( sanitize_text_field( $search ) ),
		'user'        => ye_convert( sanitize_text_field( $user ) ),
		'modest'      => ye_convert( sanitize_text_field( $modest ) ),
		'playsinline' => ye_convert( sanitize_text_field( $playsinline ) ),
		'cc_lang'     => sanitize_text_field( $cc_lang ),
		'language'    => sanitize_text_field( $language ),
		'lazyload'    => ye_convert( sanitize_text_field( $lazyload ) ),
	);
...
function ye_thumbnail_sc( $paras = '', $content = '' ) {
	...
	$array = array(
		...
		'nolink'  => sanitize_text_field( $nolink ),
	);
